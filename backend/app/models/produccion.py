...
# Tabla de relación muchos-a-muchos: órdenes ↔ lotes de materia prima usados
...
class OrdenProduccion(Base):
    ...
    transformaciones = relationship(
        "TransformacionProduccion", back_populates="orden", cascade="all, delete-orphan"
    )
...
class TransformacionProduccion(Base):
    """Transformaciones durante la producción (cocción, congelación, empaquetado)"""
